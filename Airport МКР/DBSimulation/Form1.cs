...
namespace DBSimulation
{
    public partial class Form1 : Form
    {
        ...
        private void Show(List<PC> list)
        {
            ...
            {
                dataGridView1.Rows[i].Cells[0].Value = list[i].flight_number;
                dataGridView1.Rows[i].Cells[1].Value = list[i].City_of_arrival;
                dataGridView1.Rows[i].Cells[2].Value = list[i].Number_of_seats;
                dataGridView1.Rows[i].Cells[3].Value = list[i].flight_time;
                dataGridView1.Rows[i].Cells[4].Value = list[i].ticket_price;
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            sw.WriteLine(textBoxPrice.Text);
            sw.Close();
