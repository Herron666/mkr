...
namespace DBSimulation
{
    public partial class Form1 : Form
    {
        ...
        private void Show(List<PC> list)
        {
            ...
            {
                dataGridView1.Rows[i].Cells[0].Value = list[i].SNS;
                dataGridView1.Rows[i].Cells[1].Value = list[i].sex;
                dataGridView1.Rows[i].Cells[2].Value = list[i].year_of_graduation;
                dataGridView1.Rows[i].Cells[3].Value = list[i].competitive_score;
            }
        }
